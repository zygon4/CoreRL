...
final class Graph<T extends Comparable<T>> {
    ...
    /**
     * Creates a Graph from the vertices and edges. This defaults to an
     * undirected Graph
     *
     * NOTE: Duplicate vertices and edges ARE allowed. NOTE: Copies the vertex
     * and edge objects but does NOT store the Collection parameters itself.
     *
    ...
    /**
     * Creates a Graph from the vertices and edges.NOTE: Duplicate vertices and
     * edges ARE allowed.
     *
     * NOTE: Copies the vertex and edge objects but does NOT store the
